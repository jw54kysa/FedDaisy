...
name = f"FedDC_cifar10_{iid_data_info}nc{args.num_clients}cl_n{args.num_samples_per_client}_b{args.train_batch_size}_l0_0_1_d{args.daisy_rounds}_a{args.aggregate_rounds}_r{args.num_rounds}_rc{args.restrict_classes}_s{args.seed}"
